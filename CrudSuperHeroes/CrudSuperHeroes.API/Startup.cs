...
namespace CrudSuperHeroes.API
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<CrudSuperHeroDbContext>(options =>
            {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwagger();
                app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", "CrudSuperHeroes.API v1"));
            }
